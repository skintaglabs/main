#!/usr/bin/env python3
"""Train EfficientNet-B0 for mobile deployment via knowledge distillation.
...
Usage:
    ...
    python scripts/train_efficientnet.py --epochs 30 --retraining_teacher --teacher_dir results/cache/clinical_v20260204_161741/siglip_finetuned
"""
...
def get_transforms(image_size=224, field_augment=True):
    """Get train and validation transforms for EfficientNet.
